package com.longthph30891.chatapp.firebase;
...
import com.longthph30891.chatapp.activities.ChatActivity;
...
public class MessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage message) {
        ...
        builder.setSmallIcon(R.drawable.id_notifications);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            ...
            int inpotance = NotificationManager.IMPORTANCE_DEFAULT;
            NotificationChannel channel = new NotificationChannel(channelId,channelName,inpotance);
